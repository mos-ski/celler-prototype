...
export const PROVIDERS: Record<BillCategory, BillProvider[]> = {
  airtime: [
    ...
    { id: "glo",     name: "Glo",     initials: "Glo",   color: "bg-green-600"  },
    { id: "airtel",  name: "Airtel",  initials: "Air",   color: "bg-red-600"    },
    { id: "9mobile", name: "9mobile", initials: "9mob",  color: "bg-emerald-700"},
  ],
  data: [
    { id: "mtn",     name: "MTN",     initials: "MTN",   color: "bg-yellow-500" },
    { id: "glo",     name: "Glo",     initials: "Glo",   color: "bg-green-600"  },
  ...
  electricity: [
    { id: "ekedc",  name: "Eko Electric (EKEDC)",      initials: "EKO", color: "bg-blue-600"   },
    { id: "ikedc",  name: "Ikeja Electric (IKEDC)",    initials: "IKJ", color: "bg-orange-600" },
    { id: "aedc",   name: "Abuja Electric (AEDC)",     initials: "ABJ", color: "bg-indigo-600" },
    { id: "phed",   name: "Port Harcourt Electric",    initials: "PHC", color: "bg-cyan-600"   },
    { id: "ibedc",  name: "Ibadan Electric (IBEDC)",   initials: "IBD", color: "bg-amber-600"  },
    { id: "kedco",  name: "Kano Electric (KEDCO)",     initials: "KAN", color: "bg-rose-600"   },
  ],
  tv: [
    { id: "dstv",      name: "DStv",     initials: "D",  color: "bg-blue-700"   },
    { id: "gotv",      name: "GOtv",     initials: "GO", color: "bg-green-700"  },
    { id: "startimes", name: "Startimes",initials: "ST", color: "bg-orange-700" },
    { id: "showmax",   name: "Showmax",  initials: "SM", color: "bg-purple-700" },
  ],
  betting: [
    { id: "bet9ja",   name: "Bet9ja",   initials: "B9", color: "bg-green-600"  },
    { id: "sportybet",name: "SportyBet",initials: "SB", color: "bg-red-600"    },
    { id: "1xbet",    name: "1xBet",    initials: "1X", color: "bg-blue-700"   },
    { id: "betking",  name: "BetKing",  initials: "BK", color: "bg-yellow-600" },
